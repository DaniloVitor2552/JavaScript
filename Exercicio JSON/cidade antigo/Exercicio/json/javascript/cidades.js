...
var arrayFiltrado = (cidades) => cidades.sigla == "AC"; 

var filtrarEstados = cidades.filter(arrayFiltrado);

var arrayFiltrarCidades = (cidades) => cidades.nome == "Acre";
var filtrandoCidades = cidades.filter(arrayFiltrarCidades);

var tamanhoCidades = filtrandoCidades.length;

for(i = 0; ; i++){

}

console.log(tamanhoCidades);

// console.log(filtrarEstados[0].cidades[9].nome);
