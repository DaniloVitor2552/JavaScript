const $vMinimo = document.getElementById("valor_minimo");
const $vMaximo = document.getElementById("valor_maximo");
const $bPares = document.getElementById("botao_pares");
const $bFato = document.getElementById("botao_Fatorial");
const $bFibo = document.getElementById("botao_Fibo");
const $bPrimo = document.getElementById("botao_Primo");
